Name: igi-test-ca-email
Version: 1.0.0
Release: 1%{?dist}
Summary: A test CA for IGI with an email address in the subject
...
install -m 644 -p certs/*.ks $RPM_BUILD_ROOT%{_datadir}/%{name}
...
%changelog
* Tue Nov 19 2013 Andrea Ceccanti <andrea.ceccanti at cnaf.infn.it> - 1.0.0-1
- Initial release
